...
class NeedleGuide(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "NeedleGuide"  # TODO: make this more human readable by adding spaces
    ...
    self.parent.contributors = ["Tamas Ungi (Queen's University, Canada)"]  # TODO: replace with "Firstname Lastname (Organization)"
...
class NeedleGuideLogic(ScriptedLoadableModuleLogic):
  ...
  CONNECTOR_NODE = "NeedleGuideConnector"
  ...
  def setDefaultParameters(self, parameterNode):
    ...
    """
    if not parameterNode.GetParameter(self.CONNECTOR_HOSTNAME):
      parameterNode.SetParameter(self.CONNECTOR_HOSTNAME, "localhost")
